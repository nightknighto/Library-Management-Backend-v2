 ...
 */
export function handleRequestValidationError(error: ZodError, res: Response): void {
    // Input validation error: client request didn't match contract.
    // Return 400 with structured issues for client debugging.
 ...
 * @param res - Express response object
 */
export function handleResponseValidationError(error: ZodError, res: Response): void {
 ...
 */
function handleGenericError(error: unknown, res: Response): void {
