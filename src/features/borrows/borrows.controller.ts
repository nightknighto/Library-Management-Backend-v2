...
async function borrowBook(req: Request<BorrowDTOs["BorrowBookParams"]>, res: Response) {
...
async function returnBook(req: Request<BorrowDTOs["ReturnBookParams"]>, res: Response) {
    const { isbn } = req.params;
    const user_email = req.user!.email;
...
async function getOverdueBooks(req: Request, res: Response) {
    try {
